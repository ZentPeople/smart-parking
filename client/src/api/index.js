...
export const registerUser = (formData) =>
  API.post(`${urlUser}/register`, formData);

export const resendOTP = (formData) =>
  API.post(`${urlUser}/resendOTP`, formData);

export const verifyEmail = (formData) =>
  API.post(`${urlUser}/verifyEmail`, formData);
...
export const postFeedback = (formData) =>
  API.post(`${urlUser}/feedback`, formData);

export const setProfilePic = (formData) =>
  API.post(`${urlUser}/profilePic`, formData);

export const sendSubscription = (subscription) =>
  API.post(`${urlUser}/notifications/subscribe`, subscription);

export const sendResetEmail = (formData) =>
  API.post(`${urlUser}/resetEmail`, formData);

export const resetPassword = (formData) =>
  API.post(`${urlUser}/resetPassword`, formData);
...
export const postParkingLot = (formData) =>
  API.post(`${urlParkingLot}`, formData);

export const getFreeParkingLots = (formData) =>
  API.get(`${urlParkingLot}`, {
    params: formData,
  });

export const bookSlot = (formData) =>
  API.post(`${urlParkingLot}/book`, formData);

export const getBookedSlots = () => API.get(`${urlParkingLot}/bookedSlots`);

export const cancelBookedSlot = (formData) =>
  API.delete(`${urlParkingLot}/cancelSlot`, { data: formData });
...
export const getUserHistory = (formData) =>
  API.get(`${urlAdmin}/userHistory`, { params: formData });

export const getParkingLotsNear = (formData) =>
  API.get(`${urlAdmin}/parkingLotsNear`, { params: formData });

export const getParkingLots = () => API.get(`${urlAdmin}/parkingLots`);

export const getParkingLotHistory = (formData) =>
  API.get(`${urlAdmin}/parkingLotHistory`, { params: formData });

export const deleteParkingLot = (formData) =>
  API.delete(`${urlAdmin}/removeParkingLot`, { data: formData });

export const makeActiveParkingLot = (id) =>
  API.post(`${urlAdmin}/activeLot`, { id: id });
...
export const checkoutBookSlot = (formData) =>
  API.post(`${urlPayments}/checkoutBookSlot`, formData);

export const getRazorPayKey = () => API.get(`${urlPayments}/razorPayKey`);

export const checkoutRefund = (formData) =>
  API.post(`${urlPayments}/checkoutRefund`, formData);
